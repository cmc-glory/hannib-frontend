...
type HoldingSharingBottomSheetContentProps = {
  itemFilter: '전체보기' | '수령완료' | '미수령'
  setItemFilter: React.Dispatch<React.SetStateAction<'전체보기' | '수령완료' | '미수령'>>
  close?: () => void
}
...
export const HoldingSharingBottomSheetContent = ({itemFilter, setItemFilter, close}: HoldingSharingBottomSheetContentProps) => {
