...
export const HomeIcon = () => {
  return <Icon uri="http://localhost:8081/src/assets/Icon/House.png"></Icon>
}
...
export const CommunityIcon = () => {
  return <Icon uri="http://localhost:8081/src/assets/Icon/users.png"></Icon>
}
...
export const ChattingIcon = () => {
  return <Icon uri="http://localhost:8081/src/assets/Icon/Chat.png"></Icon>
}
...
export const CalendarIcon = () => {
  return <Icon uri="http://localhost:8081/src/assets/Icon/Calender.png"></Icon>
}
...
export const AccountIcon = () => {
  return <Icon uri="http://localhost:8081/src/assets/Icon/account.png"></Icon>
}
